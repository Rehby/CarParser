...
def getresponse():
    ...
    headers = {
        ...
        'Pragma': 'no-cache',
        'Referer': 'https://auto.ru/orenburg/cars/used/do-700000/?sort=cr_date-desc',
        ...
        'x-retpath-y': 'https://auto.ru/orenburg/cars/used/do-700000/?sort=cr_date-desc',
...
def add_car(car):
    ...
    url = f'https://auto.ru/cars/used/sale/{mark}/{model_info}/{carid}'
...
def getdata():
    ...
    for car in cars:
       add_car(car)
    with open("getcars.json","w") as f:
        json.dump(getcars, f, indent=4, ensure_ascii=False)
    print(getcars)
